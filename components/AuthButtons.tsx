...
export default function AuthButtons() {
    ...
    if (email)
        return <div className="auth-actions"><Link href="/history" className="auth-user">{email}</Link><button type="button" onClick={logout} className="auth-login">Log out</button></div>;
