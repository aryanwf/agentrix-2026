    ...
    return (<main className="lp">
      ...
      <section className="lp-hero">
        ...
        <div className="lp-stage">
          ...
          <img className="lp-figure" src="/brand/cura.webp" alt="Cura, the companion avatar, mid-conversation" width={830} height={1450} fetchPriority="high"/>
      ...
      <nav className="lp-apps" aria-label="Ways in">
        {apps.map(({ name, href, icon: Icon, label, blurb }) => (<button className="lp-app" type="button" key={name} onClick={() => router.push(href)}>
