...
declare module "@met4citizen/talkinghead" {
    ...
    export class TalkingHead {
        ...
        isSpeaking: boolean;
        showAvatar(avatar: AvatarDescriptor, onprogress?: (e: ProgressEvent) => void): Promise<void>;
        speakText(s: string, opt?: SpeakOptions, onsubtitles?: (word: string) => void, excludes?: [
            number,
            number
        ][]): void;
        speakAudio(r: {
            ...
            vtimes?: number[];
            vdurations?: number[];
        }, opt?: SpeakOptions, onsubtitles?: (word: string) => void): void;
